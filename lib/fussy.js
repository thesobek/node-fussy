...
(function() {
  ...
  exports.Engine = (function() {
    ...
    Engine.prototype.extractFacetsFromRawContent = function(raw) {
      var content, facets, k, ngram, ngram_weight, ngrams, synonym, synonym_weight, v, word, _ref, _ref1, _ref2, _ref3;
      ...
      for (ngram in ngrams) {
        ...
        if (!((this.stringSize[0] < (_ref2 = word.length) && _ref2 < this.stringSize[1]))) {
          continue;
        }
        if (word in this.network) {
          _ref3 = this.network[word];
