...
(function() {
  var NEGATIVE, NEUTRAL, P, POSITIVE, cleanContent, contentToSentences, debug, emptyThesaurus, fs, isString, ngramize, numerize, pick, replaceAll, _ngramize,
  ...
  contentToSentences = function(content) {
  ...
  exports.Engine = (function() {
    ...
    Engine.prototype.extractFacetsFromRawContent = function(raw) {
      var content, facets, k, ngram, ngram_weight, ngrams, sentence, sentences, synonym, synonym_weight, usePonderation, v, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      usePonderation = false;
      ...
      for (_i = 0, _len = sentences.length; _i < _len; _i++) {
        ...
        _ref = ngramize(sentence, this.ngramSize);
        for (k in _ref) {
          v = _ref[k];
          ngrams[k] = v;
        }
        _ref1 = numerize(sentence);
        for (k in _ref1) {
          v = _ref1[k];
          ngrams[k] = v;
        }
      ...
      for (ngram in ngrams) {
        ...
        if (ngram in this.network) {
          ...
          for (synonym in _ref3) {
            ...
            if (usePonderation) {
              facets[synonym] = ngram_weight * synonym_weight + ((_ref4 = facets[synonym]) != null ? _ref4 : 0);
            } else {
              facets[synonym] = 1 + ((_ref5 = facets[synonym]) != null ? _ref5 : 0);
            }
          }
        }
        facets[ngram] = ngram_weight + ((_ref6 = facets[ngram]) != null ? _ref6 : 0);
      }
      return facets;
    };
