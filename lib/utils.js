...
(function() {
  var colors, csvString, deck, fields2map, find, findsum, fs, isArray, isBoolean, isEmpty, isFunction, isNumber, isString, loadJSON, loadSchema, parse, parse_cache, path, pperf, pretty, pstats, util,
  ...
  exports.parse = parse = function(schema, row) {
